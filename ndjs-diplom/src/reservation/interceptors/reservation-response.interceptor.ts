...
import { IReservationResponse } from '../dto/reservation.dto';

/** Преобразование формата выходных данных номера отеля */
@Injectable()
export class ReservationResponseInterceptor implements NestInterceptor {
  intercept(
    context: ExecutionContext,
    next: CallHandler,
  ): Observable<IReservationResponse | IReservationResponse[]> {
    const formatReservationResponse = (
